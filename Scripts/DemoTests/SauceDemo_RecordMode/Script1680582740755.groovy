...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/div_Sauce Labs Bolt T-ShirtGet your testing_ee3ceb'))
...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_firstName'), 'udin')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'), 'petot')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_postalCode'), '165982')
